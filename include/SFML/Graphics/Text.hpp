...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Enumeration of the text alignment
    ///
    ////////////////////////////////////////////////////////////
    enum Alignment
    {
        Left   = 0, //!< Тext is left aligned
        Center = 1, //!< Тext is centered
        Right  = 2  //!< Тext is right aligned
    };
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the text's alignment
    ///
    /// \return Text's alignment
    ///
    /// \see setAlignment
    ///
    ////////////////////////////////////////////////////////////
...
private:
    ...
    Uint32                           m_alignment;           //!< Text alignment (see Alignment enum)
    Color                            m_fillColor;           //!< Text fill color
    Color                            m_outlineColor;        //!< Text outline color
    float                            m_outlineThickness;    //!< Thickness of the text's outline
    mutable std::vector<VertexArray> m_vertices;            //!< Vector of vertex arrays containing the fill geometry for the each line of the text
    mutable std::vector<VertexArray> m_outlineVertices;     //!< Vector of vertex arrays containing the outline geometry for the each line of the text
